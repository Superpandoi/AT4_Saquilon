...
/////// -------------------  MY COMMENTS! -----------------------------------
/* This Java file creates a window that allows a user to delete student data from a JSON file. 
The window contains a text field where the user can enter the username of the student to be deleted. 
When the "Delete" button is clicked, the code reads the user.json file, finds the user with the matching username, 
removes them from the list of users, and then writes the updated list back to the user.json file. There are also buttons 
to navigate back to the welcome screen and to clear the username text field. */
...
public class Deletestudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(dtext1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 140, 210, 30));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 200, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/at4_saquilon/background.jpg"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 480, 320));
    ...
    File file = new File("src\\at4_saquilon\\user.json"); {
    if (!file.exists()) {
        JOptionPane.showMessageDialog(this, "Error");
    }
